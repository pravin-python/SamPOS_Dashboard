...
CSRF_TRUSTED_ORIGINS = os.getenv.list(
...
SECURE_CONTENT_TYPE_NOSNIFF = os.getenv.bool('DJANGO_SECURE_CONTENT_TYPE_NOSNIFF', default=True)
...
SECURE_HSTS_SECONDS = os.getenv.int('DJANGO_SECURE_HSTS_SECONDS', default=2592000) # 30 days
...
SECURE_HSTS_PRELOAD = os.getenv.bool('DJANGO_SECURE_HSTS_PRELOAD', default=False)
